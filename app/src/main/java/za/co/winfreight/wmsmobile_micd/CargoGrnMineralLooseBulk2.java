...
public class CargoGrnMineralLooseBulk2 extends AppCompatActivity {
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.CargoGrnMineralLooseBulk2_rbYes:{
                if (checked){
                    isDamaged=true;
            ...
            case R.id.CargoGrnMineralLooseBulk2_rbNo:{
                if (checked) {
                    isDamaged = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cargo_grn_mineral_loose_bulk2);
        txt = findViewById(R.id.CargoGrnMineralLooseBulk2_lblTakePhotoPrompt);
        btn1 = findViewById(R.id.CargoGrnMineralLooseBulk2_btn1);
        btn2 = findViewById(R.id.CargoGrnMineralLooseBulk2_btn2);
    ...
    public void CargoGrnMineralLooseBulk2_btn_Clicked(View v){
        String buttonTag = v.getTag().toString();
        switch (buttonTag){
            case "CargoGrnMineralLooseBulk2_btn1":{
                _pictureType = "TarpPhotoDamage1";
                break;
            }
            case "CargoGrnMineralLooseBulk2_btn2":{
                _pictureType = "TarpPhotoDamage2";
                break;
            }
            case "CargoGrnMineralLooseBulk2_btn3":{
                _pictureType = "TrailerACargoTop";
                break;
            }
            case "CargoGrnMineralLooseBulk2_btn4":{
    ...
    public void CargoGrnMineralLooseBulk2_btnBack_Clicked(View v){
        Intent intent = new Intent(this, CargoGrnMineralLooseBulk1.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }

    public void CargoGrnMineralLooseBulk2_btnNext_Clicked(View v){
        if (isDamaged){
        ...
        Intent intent = new Intent(this, CargoGrnMineralLooseBulk3.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }
    ...
    public void afterPhotoTakenAction(){
        ...
        switch (_pictureType){
            case "TarpPhotoDamage1":{
                btn = findViewById(R.id.CargoGrnMineralLooseBulk2_btn1);
                tarpPhotoDamage1=true;
                break;
            }
            case "TarpPhotoDamage2":{
                btn = findViewById(R.id.CargoGrnMineralLooseBulk2_btn2);
                tarpPhotoDamage2=true;
                break;
            }
            case "TrailerACargoTop":{
                btn = findViewById(R.id.CargoGrnMineralLooseBulk2_btn3);
                trailerACargoTop=true;
                break;
            }
            case "TrailerBCargoTop":{
                btn = findViewById(R.id.CargoGrnMineralLooseBulk2_btn4);
