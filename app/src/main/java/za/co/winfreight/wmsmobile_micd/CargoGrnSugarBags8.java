...
public class CargoGrnSugarBags8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cargo_grn_sugar_bags8);
        txt = findViewById(R.id.CargoGrnSugarBags8_lblTakePhotoPrompt);
        btn1 = findViewById(R.id.CargoGrnSugarBags8_btn1);

        txt.setVisibility(View.INVISIBLE);
        btn1.setVisibility(View.INVISIBLE);

        txtBags = findViewById(R.id.CargoGrnSugarBags8_txtNumberOfBags);
        llHowMany = findViewById(R.id.CargoGrnSugarBags8_llHowMany);
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.CargoGrnSugarBags8_rbYes:{
                if (checked){
                    isDamaged=true;
            ...
            case R.id.CargoGrnSugarBags8_rbNo:{
                if (checked) {
                    isDamaged = false;
                    txt.setVisibility(View.INVISIBLE);
                    btn1.setVisibility(View.INVISIBLE);
    ...
    public void CargoGrnSugarBags8_btn_Clicked(View v){
        photoTaken=true;
        _pictureType = String.format("DirtyBag%s",Count);
        takePhoto(_pictureType);
    }

    public void CargoGrnSugarBags8_btnBack_Clicked(View v){
        Intent intent = new Intent(this, CargoGrnSugarBags7.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }

    public void CargoGrnSugarBags8_btnNext_Clicked(View v){
        if (isDamaged){
            if (!photoTaken){
                Toast.makeText(this,"Take photos of the dirty bags", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            q.updateGateInSugarBags(((master)getApplicationContext()).getUser(), myCargo.getDocumentNr(),"Dirty", txtBags.getText().toString());
        }
