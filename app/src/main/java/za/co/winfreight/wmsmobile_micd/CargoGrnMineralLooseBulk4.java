...
public class CargoGrnMineralLooseBulk4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cargo_grn_mineral_loose_bulk4);
        txt = findViewById(R.id.CargoGrnMineralLooseBulk4_lblTakePhotoPrompt);
        btn1 = findViewById(R.id.CargoGrnMineralLooseBulk4_btn1);
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.CargoGrnMineralLooseBulk4_rbYes:{
                if (checked){
                    isDamaged=true;
            ...
            case R.id.CargoGrnMineralLooseBulk4_rbNo:{
                if (checked) {
                    isDamaged = false;
                    txt.setVisibility(View.INVISIBLE);
                    btn1.setVisibility(View.INVISIBLE);
    ...
    public void CargoGrnMineralLooseBulk4_btn_Clicked(View v){
        Count++;
        _pictureType = String.format("Moisture%s",Count);
        takePhoto(_pictureType);
    }

    public void CargoGrnMineralLooseBulk4_btnBack_Clicked(View v){
        Intent intent = new Intent(this, CargoGrnMineralLooseBulk3.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }

    public void CargoGrnMineralLooseBulk4_btnNext_Clicked(View v){
        if (isDamaged){
            if (Count == 0){
        ...
        Intent intent = new Intent(this, CargoGrnMineralLooseBulk5.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }
