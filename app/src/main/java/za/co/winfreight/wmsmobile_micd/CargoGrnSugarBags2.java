...
public class CargoGrnSugarBags2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cargo_grn_sugar_bags2);
        txt = findViewById(R.id.cargoGrnSugarBags2_lblTakePhotoPrompt);
        btn1 = findViewById(R.id.cargoGrnSugarBags2_btn1);
        btn2 = findViewById(R.id.cargoGrnSugarBags2_btn2);

        tarpPhotoDamage1 = false;
        tarpPhotoDamage2 = false;
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.cargoGrnSugarBags2_rbYes:{
                if (checked){
                    isDamaged=true;
            ...
            case R.id.cargoGrnSugarBags2_rbNo:{
                if (checked) {
                    isDamaged = false;
                    txt.setVisibility(View.INVISIBLE);
                    btn1.setVisibility(View.INVISIBLE);
    ...
    public void cargoGrnSugarBags2_btn_Clicked(View v){
        String buttonTag = v.getTag().toString();
        switch (buttonTag){
            case "cargoGrnSugarBags2_btn1":{
                _pictureType = "TarpPhotoDamage1";
                break;
            }
            case "cargoGrnSugarBags2_btn2":{
    ...
    public void cargoGrnSugarBags2_btnBack_Clicked(View v){
        Intent intent = new Intent(this, CargoGrnSugarBags1.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }

    public void cargoGrnSugarBags2_btnNext_Clicked(View v){
        if (isDamaged){
    ...
    public void afterPhotoTakenAction(){
        ...
        switch (_pictureType){
            case "TarpPhotoDamage1":{
                btn = findViewById(R.id.cargoGrnSugarBags2_btn1);
                tarpPhotoDamage1=true;
                break;
            }
            case "TarpPhotoDamage2":{
                btn = findViewById(R.id.cargoGrnSugarBags2_btn2);
