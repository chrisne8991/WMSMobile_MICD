...
public class CargoGrnMineralBags1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cargo_grn_mineral_bags1);
    ...
    public void CargoGrnMineralBags1_btnBack_Clicked(View v){
        Intent intent = new Intent(this, CargoGrnActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }

    public void CargoGrnMineralBags1_btnNext_Clicked(View v){
    ...
    public void CargoGrnMineralBags1_btn_Clicked(View v){
        String buttonTag = v.getTag().toString();
        switch (buttonTag){
            case "CargoGrnMineralBags1_btn1":{
                _pictureType = "TruckRegistration";
                break;
            }
            case "CargoGrnMineralBags1_btn2":{
                _pictureType = "Vehicle";
                break;
            }
            case "CargoGrnMineralBags1_btn3":{
                _pictureType = "StockpileBoard";
                break;
            }
            case "CargoGrnMineralBags1_btn4":{
                _pictureType = "FullTruckSeals";
                break;
            }
            case "CargoGrnMineralBags1_btn5":{
                _pictureType = "FullTruckTrailerATop";
                break;
            }
            case "CargoGrnMineralBags1_btn6":{
    ...
    public void afterPhotoTakenAction(){
        ...
        switch (_pictureType){
            case "Vehicle":{
                btn = findViewById(R.id.CargoGrnMineralBags1_btn2);
                photoVehicle=true;
                break;
            }
            case "TruckRegistration":{
                btn = findViewById(R.id.CargoGrnMineralBags1_btn1);
                photoTruckRegistration=true;
                break;
            }
            case "StockpileBoard":{
                btn = findViewById(R.id.CargoGrnMineralBags1_btn3);
                photoStockpileBoard=true;
                break;
            }
            case "FullTruckSeals":{
                btn = findViewById(R.id.CargoGrnMineralBags1_btn4);
                photoFullTruckWithSeals=true;
                break;
            }
            case "FullTruckTrailerATop":{
                btn = findViewById(R.id.CargoGrnMineralBags1_btn5);
                photoFullTruckWithTrailerATop=true;
                break;
            }
            case "FullTruckTrailerBTop":{
                btn = findViewById(R.id.CargoGrnMineralBags1_btn6);
